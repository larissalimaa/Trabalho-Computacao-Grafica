...
function timerUpdate() {
    if (contadorCheck >= 1) {
        ...
        var information = document.getElementById("InfoxBox");
        information.innerHTML = "Volta (" + lap + "/4)<br><br>Tempo da volta: " + minutes + ":" + seconds
...
function contaVoltasPista1(truck) {
    //var checkpoint = arrayPistaOne[0]
    //checkpoint.set
    var checkpoint_x = -270;
    var checkpoint_z = 0;

    var checkpoint_x2 = -510;
    var checkpoint_z2 = -600;
    ...
    //let posicaoBlocoInicial_x = blocoInicial.position.x
    //let posicaoBlocoInicial_z = blocoInicial.position.z
    ...
    if (
        ...
        posicaoCarroX == posicaoBlocoInicial_x - blockSize / 2 &&
        posicaoCarroZ == posicaoBlocoInicial_z - blockSize / 2 &&
        posicaoCarroX == posicaoBlocoInicial_x + blockSize / 2 &&
        posicaoCarroZ == posicaoBlocoInicial_z + blockSize / 2 &&
        voltaAtual < contadorCheck
    ) {
        ...
        // canFinish = true;
        //  console.log("passou linha chegada")
    ...
    if (posicaoCarroX == checkpoint_x - blockSize / 2 &&
        ...
        console.log("contadorCheck=")
        console.log(contadorCheck)
        //ou eu zero ele, sempre, quando virar uma pista
        //ou eu coloco um limite superior 
        contadorCheck = contadorCheck + 1;


    }

    if (posicaoCarroX == checkpoint_x2 - blockSize / 2 &&
        posicaoCarroZ == checkpoint_z2 - blockSize / 2 &&
        posicaoCarroX == checkpoint_x2 + blockSize / 2 &&
        posicaoCarroZ == checkpoint_z2 + blockSize / 2
    ) {
...
function contaVoltasPista(truck) {
    ...
    //let posicaoBlocoInicial_ = blocoInicial.position.x
    //let posicaoBlocoInicial_z = blocoInicial.position.z
    let posicaoBlocoInicial_x = -270;
    let posicaoBlocoInicial_z = 0;
    //console.log("voltaAtual")
